...
(function() {
    ...
    libav.LibAV = function(opts) {
        ...
        var toImport = opts.toImport || libav.toImport ||
            base + "/libav-5.1.6.1.1-d89883a-" + variant + ".dbg." + t + "." +
       "js";
        var ret;
